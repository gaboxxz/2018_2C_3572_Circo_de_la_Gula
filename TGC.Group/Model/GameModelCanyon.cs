...
namespace TGC.Group.Model
{
    public class GameModelCanyon : TgcExample, IGameModel
    {
        ...
        {
            PreRender();
            Bandicoot.Transform = TGCMatrix.Translation(Bandicoot.Position.X-100, Bandicoot.Position.Y, Bandicoot.Position.Z-35) * Scale * Rotation * new TGCMatrix(Physics.BandicootRigidBody.InterpolationWorldTransform)
